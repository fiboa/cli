...
- CH: publish `lnf_code` as `crop:code` with the BLW usage catalogue as `crop:code_list`; the crop extension requires both and the output failed validation without them
