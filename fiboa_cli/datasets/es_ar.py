...
# (https://idearagon.aragon.es/descargas, "SIGPAC"). The per-province archives
# are unreliable — Teruel's disappeared in 2026 — so the per-municipality
# shapefiles are used instead.
