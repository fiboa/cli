...
class AddHCATMixin:
    ...
    # Tables that fill gaps in the main one: EuroCrops splits France over
    # fr_2018.csv and fr_other_years.csv, and naming only the first leaves every
    # later code unmapped. Rows here win where both carry a code.
