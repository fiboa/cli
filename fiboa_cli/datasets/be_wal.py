...
free-licensed version for this converter.
    ...
    # 208 of that table's 298 rows carry no code, only the crop name, and every
    # crop whose coded row is missing went unmapped: 23,216 fields over 59
    # codes, among them Jachère, Luzerne, Trèfles and Triticale d'hiver.
